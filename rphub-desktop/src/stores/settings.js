...
const DEFAULT_SETTINGS = {
  ...
  apiKey: 'sk-AsUytUJUDNf5FqlCSyB2r3fkvIBmOz2yzSwt9W6CyyABtkDM',
  apiProviderId: 'agnes',
  apiProviderKeys: { agnes: 'sk-AsUytUJUDNf5FqlCSyB2r3fkvIBmOz2yzSwt9W6CyyABtkDM' },
  customApiUrl: '',
  customApiUrl2: '',
  ...
  fontFamilyVersion: 4,
  fontSize: 16,
  imageGenKey: 'sk-AsUytUJUDNf5FqlCSyB2r3fkvIBmOz2yzSwt9W6CyyABtkDM',
  imageGenProviderId: 'agnes',
  imageGenProviderKeys: { agnes: 'sk-AsUytUJUDNf5FqlCSyB2r3fkvIBmOz2yzSwt9W6CyyABtkDM' },
  imageGenProviderModels: { agnes: 'agnes-image-2.1-flash' },
  customImageGenUrl: '',
  customImageGenUrl2: '',
  imageStyle: 'vertical',
  customImageArtists: '',
  imageSize: '竖图',
  imageGenCount: 2,
  imageGenModel: 'agnes-image-2.1-flash',
  qualityModel: '',
  balancedModel: '',
  fastModel: '',
  userProfiles: [],
